                    ...
                    <div className="card project-list-card shadow">
                        <div className="card-body">
                            ...
                            <div className="text-left mb-3">
                                <button
                                    onClick={() => navigate('/coord/*/create-project')}
                                ...
                                <tbody>
                                    {filteredProjects.map(project => (
                                        <tr key={project.id} className="row-clickable">
                                            <td><Link to={`/coord/*/project-details/${project.id}`}>{project.name}</Link></td>
                                            ...
                                            <td>
                                                ...
                                                <button className="btn btn-secondary" onClick={() => navigate(`/coord/*/project-details/${project.id}`)}>View Details</button>
                                            </td>
                                        </tr>
                                    ))}
                                </tbody>
