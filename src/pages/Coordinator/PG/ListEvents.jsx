                    ...
                    <div className="card event-list-card shadow">
                        <div className="card-body">
                                ...
                                <tbody>
                                    {filteredEvents.map(event => (
                                        <tr key={event.id} className="row-clickable" onClick={() => (event.id)}>
                                            <td><Link to={`/coord/*/EventDetails/${event.id}`}>{event.subject}</Link></td>
                                            ...
                                            <td>
                                                ...
                                                <button className="btn btn-secondary" onClick={() => navigate(`/coord/*/EventDetails/${event.id}`)}>View Details</button>
                                            </td>
                                        </tr>
                                    ))}
                                </tbody>
                            ...
                            <div className="text-left mb-3">
                                <button
                                    onClick={() => navigate('/coord/*/event-scheduler')}
